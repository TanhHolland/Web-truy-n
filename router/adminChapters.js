...
router.put(
    "/update/:slug",
    Check.adminChapters,
    AdminChapters.PutAdminChaptersEdit
);
...
router.patch(
    "/chapter-trash/restor/:id",
    AdminChapters.PatchAdminChaptersRestor
);

router.delete(
    "/chapter-trash/destroy/:id",
    AdminChapters.DeleteAdminChaptersDestroy
);
...
router.put(
    ...
    AdminChapters.PutAdminChaptersContent
);
